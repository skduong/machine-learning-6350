...
for(i in 2:6){
  x=ggplot(LOWmpg,aes(as.matrix(LOWmpg)[,i]))+
    geom_histogram()+labs(x=names(auto)[i])+
    theme(text=element_text(size=20))
...
Ctrain1=table(Rclass_true,Rclass_pred1)
Ctrain2=table(Rclass_true,Rclass_pred2)
Ctrain3=table(Rclass_true,Rclass_pred3)

Ctest1=table(Eclass_true,Eclass_pred1)
Ctest2=table(Eclass_true,Eclass_pred2)
Ctest3=table(Eclass_true,Eclass_pred3)
